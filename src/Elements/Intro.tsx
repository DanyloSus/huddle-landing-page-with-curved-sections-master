const Intro = () => {
  return (
    <section className="text-center max-w-[1016px] mx-auto flex flex-col gap-10 items-center mt-[200px] lg:max-w-[290px] lg:mt-[100px] lg:gap-5 reveal">
